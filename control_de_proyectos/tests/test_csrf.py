...
class AvanceCsrfTests(TestCase):
    def setUp(self):
        ...
        self.vista_modificar = Vista.objects.create(nombre='Control de Proyectos - Tareas')
        self.vista_detalle = Vista.objects.create(nombre='Control de Proyectos - Proyectos')
