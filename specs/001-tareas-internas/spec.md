...
- **FR-F12**: Un Hito puede editarse en nombre, cumplimiento, peso y responsable. Toda edición MUST respetar la Empresa de la Tarea, usuario activo y responsable válido, cumplimiento `0..100` y el contrato vigente de pesos; no se agregan prioridad, clasificación ni `fecha_tope` propias.
...
**Key Entities — F**: Avance, Hito (responsable, anulado, peso, cumplimiento, fecha_creacion), HitoHistorial, Evidencia, Mini-tarea (hecho/no hecho, persona).
