...
- [x] T100 [US7] Añadir forms, vistas y rutas server-side para leer/reconocer, crear, editar, ocultar/restaurar y vincular/desvincular. Usar `Tareas` + `ingresar` para lectura, `modificar` para edición/participantes y `supervisor` (S) para ocultar/restaurar; validar Empresa activa, vínculo y estado con respuestas controladas. **Depende de T097–T099**.
