...
- [ ] T030 [US3] Implementar `fecha_tope` nullable durante edición pero obligatoria al publicar, `fecha_cumplimiento` con limpieza al rechazo de cierre, cálculo derivado de atraso, causas múltiples por reprogramación y reprogramación con justificación obligatoria en `tareas/services/scheduling.py`, conforme a FR-G01…G05.
